  ...
  },
  {
    ...
    body: `
      ...
      <section class="help-section"><h3>Open a drop</h3>
        ...
        <p>Open <b>Gallery</b> when you want to browse cards rather than products. Use the <b>Set code</b> menu to show everything together or narrow the grid to SLD, SLC, SLU, SLP, SLX, PSSC, PTG, or SLZ. Every tile carries its set code and collector number. SLZ cards remain clearly marked previews and are not treated as one guaranteed product.</p>
        ...
        <p><b>Promos &amp; Related</b> keeps unusual cards honest and searchable: SLP promos, serialized and standalone SLD promotions, Showcase Plane memorabilia, Universes Within replacement printings, and the 2019 Ponies precursor each have their own labeled section. <b>Bundles</b> catalogs composite Secret Lair bundles and Festival-in-a-Box products, including known nested drops and direct promos, without pretending every component is one normal drop.</p>
        <p>The two <b>Ultimate Edition</b> products appear with regular released products because their contents are fixed: five nonfoil enemy fetch lands in the first and ten foil Pathways in Ultimate Edition 2. Their surprise bonus card remains separate from completion.</p>
      </section>
  ...
  },
  {
    ...
    body: `
      ...
      <section class="help-section"><h3>Use the decision views</h3>
        <ul><li><strong>Index</strong> can filter by year, superdrop, finish, subtype, holding state, and confidence; sort it by return, gain, value, cost, or name and export the full report to CSV.</li><li><strong>Price the singles</strong> compares the cheapest playable copies across every set with the exact Secret Lair printings in the current product. Variable-finish kits also show separate nonfoil, foil, and available premium-finish totals. Expand any total for its card-by-card prices. Dedicated foil and nonfoil products remain separate, and incomplete finish totals are labeled as subtotals.</li><li><strong>Crack-or-keep</strong> compares a sealed estimate with the complete exact-printing singles total after your fee and shipping assumptions.</li><li><strong>Watches</strong> keep local targets for products you want to revisit.</li><li><strong>Observed bonuses</strong> are your journal of actual pulls. Unknown odds and random bonuses are never added to guaranteed value.</li><li><strong>CardTrader</strong> and <strong>PriceCharting</strong> can add labeled comparisons after you enter optional tokens in Settings. They do not silently replace the main estimate.</li></ul>
      </section>

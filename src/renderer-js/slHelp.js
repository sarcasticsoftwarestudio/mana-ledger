  ...
  showModal(`
    <div style="max-width:920px">
      ...
      <div style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;font-size:12px;color:var(--text-dim)">
        ...
        <div style="padding:9px 11px;background:var(--surface);border-radius:7px"><strong style="color:var(--text)">Set galleries &amp; bundles</strong><br>${supplemental.cards.toLocaleString()} gallery cards (${supplemental.relatedCards.toLocaleString()} promos/related) · ${supplemental.bundles.toLocaleString()} bundles · ${esc(when(supplemental.generatedAt))}</div>
